...
class ApiSagaClient:
    """API сервиса Saga"""
    class EmployeeSaga:
        def get_all_sagas(self, headers: dict) -> tuple:
            """Получить список саг"""
            ...
            for el in range(len(data)):
                if data[el]['Snils']:
                    ...
                    return response.status_code, VARIABLES['Saga_User_Snils'], data, response.url

        def get_saga_with_snils(self, headers: dict) -> tuple:
        ...
        def post_employee_saga(self, headers: dict, resident: bool) -> tuple:
        ...
        def get_employee_saga_with_saga_id(self, headers: dict) -> tuple:
            ...
            for _ in range(3):
                ...
                if data['EmployeeId']:
                    ...
                    return response.status_code, VARIABLES['Created_Employee_Id'], data, response.url
                else:
                    time.sleep(5)
                    continue
