...
class ApiStaffClient:
    ...
    class Employees:
        """Сотрудники"""
        def get_countries(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def get_country(self, headers: dict) -> Union[int, str, tuple]:
            """Получить страну по id страны"""
            response = r.get(f'{BASE_URL_V1}/staff/Countries/{VARIABLES["country_code"]}', headers=headers)
            return response.status_code


        def get_employees(self, path: str, headers: dict) -> Union[int, str, tuple]:
        ...
        def get_employee_personal_info(self, headers: dict) -> Union[int, str, dict]:
        ...
        def get_employee_by_id_created_user(self, headers: dict) -> Union[int, str, dict]:
        ...
        def get_employee_certificates(self, headers: dict) -> Union[int, str, dict, tuple]:
        ...
        def put_created_employee(self, headers: dict, resident: bool) -> Union[int, str, dict, tuple]:
        ...
        def put_current_employee(self, headers: dict, resident: bool) -> Union[int, str, dict, tuple]:
        ...
        def delete_employee(self, headers: dict) -> Union[int, str]:
            """Удалить сотрудника"""
    ...
    class JobTitle:
        """Должности в staff"""
        def get_job_title(self, headers: dict) -> Union[int, str]:
    ...
    class Users:
        ...
        def put_avatar_url(self, headers: dict) -> Union[int, str]:
        ...
        def delete_avatar(self, headers: dict) -> Union[int, str]:
    ...
    class Uueses:
        """УНЭП"""
        def post_request_certificate(self, headers: dict, issue_type: str) -> Union[int, str]:
        ...
        def get_request_certificate_type(self, headers: dict) -> Union[int, str, dict]:
        ...
        def get_request_certificate_with_id(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def get_personal_info_with_certificate_id(self, headers: dict) -> Union[int, str]:
            """Получить перс. данные по Id сертификата"""
            response = r.get(f'{BASE_URL_V1}/staff/Uueses/RequestCertificates/'
                             f'{VARIABLES["Request_certificate_Id"]}/GetPersonalInfo', headers=headers)
            return response.status_code

        def post_request_certificate_passport(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def delete_request_certificate_passport(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def post_accept_personal_info(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def post_signature_blank(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def post_confirm_application(self, headers: dict) -> Union[int, str, tuple]:
        ...
        def get_certificate_blank(self, headers: dict) -> Union[int, str, dict]:
        ...
        def post_cancel_request_certificate(self, headers: dict) -> Union[int, str, tuple]:
